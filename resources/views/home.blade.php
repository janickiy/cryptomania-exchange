                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pad-tb-20 text-center">
                                <img src="{{ asset('frontend/images/logo-inverse.svg') }}?v={{ filemtime(public_path('frontend/images/logo-inverse.svg')) }}" alt="{{ company_name() }}"
                                     width="215" height="56" class="img-fluid pad-b-10 footer-brand-logo">
