        ...
        <div class="card stock-item-form-card">
            <div class="card-header d-flex align-items-center justify-content-between gap-3">
                <div class="admin-page-heading">
                    <h3 class="admin-page-title">{{ __('Create Stock Item') }}</h3>
                    <p class="admin-page-subtitle">{{ __('Configure a currency, transfer rules, and exchange availability.') }}</p>
                </div>
            ...
            <div class="card-body admin-form-body">
                {!! Form::open(['route'=>'admin.stock-items.store', 'method' => 'post', 'class'=>'validator admin-section-form stock-item-form', 'enctype'=>'multipart/form-data']) !!}
