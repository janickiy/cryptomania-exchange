    ...
    <div class="user-management-page report-payment-page">
        ...
        <div class="report-page-heading">
            <div class="admin-page-heading">
                <h3 class="admin-page-title">{{ __('List of Deposits') }}</h3>
                <p class="admin-page-subtitle">{{ __('Review incoming transactions with status, user, address, and reference details.') }}</p>
            </div>
        </div>
