    ...
    <div class="user-management-page report-payment-page">
        ...
        <div class="report-page-heading">
            <div class="admin-page-heading">
                <h3 class="admin-page-title">{{ __('Deposits of :itemName', ['itemName' => $wallet->stockItem->item]) }}</h3>
                <p class="admin-page-subtitle">{{ __('Review incoming wallet transactions, statuses, addresses, and references.') }}</p>
            </div>
        </div>
        ...
        <div class="card user-table-card report-payment-table-card">
            <div class="card-header">
                @include('backend.reports._payment_nav', ['routeName' => 'reports.admin.wallets.deposits', 'walletId' => $wallet->id])
            </div>
