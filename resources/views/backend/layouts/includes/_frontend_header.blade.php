...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('common/vendors/Ionicons/css/ionicons.min.css') }}">
    ...
    @yield('after-style')
    <link rel="stylesheet" href="{{ asset('frontend/liquid-glass.css') }}?v={{ filemtime(public_path('frontend/liquid-glass.css')) }}">
    <!--[if lt IE 9]>
