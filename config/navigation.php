...
return [
    ...
    'navigation_template' =>[
        'default_nav' => [
            'navigation_wrapper_start'=> '<ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">',
            ...
            'navigation_item_ending_wrapper_start'=> '<span class="nav-arrow">',
